...
$sqlPorStaff = "SELECT count(*) as conteo, a.staff_id, b.nombre as descripcion
                  ...
                  AND a.date_created BETWEEN ('$fechaInicio') AND ('$fechaFin')
                  GROUP by a.staff_id";
    ...
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        <a href="./index.php?page=newTicketStaffList" class="nav-link">
          ...
          <span class="info-box-number"><?php echo $conn->query("SELECT * FROM tickets WHERE date_created BETWEEN ('$fechaInicio') AND ('$fechaFin')")->num_rows; ?></span>
        </a>
      </div>
    </div>
  </div>
    ...
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        <a href="./index.php?page=newTicketStaffList" class="nav-link">
          ...
          <span class="info-box-number"><?php echo $conn->query("SELECT * FROM tickets WHERE date_created BETWEEN ('$fechaInicio') AND ('$fechaFin') AND status = 2")->num_rows; ?></span>
        </a>
      </div>
    </div>
  </div>
    ...
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        <a href="./index.php?page=newTicketStaffPersonal" class="nav-link">
          ...
          <span class="info-box-number"><?php echo $conn->query("SELECT * FROM tickets WHERE date_created BETWEEN ('$fechaInicio') AND ('$fechaFin') AND status <> 2 and staff_id = ".$_SESSION['login_id'])->num_rows; ?></span>
        </a>
      </div>
    </div>
  </div>
...
datasets: [{
  ...
  backgroundColor: ["#26547c", "#990033","#ffd166","#06d6a0","#ff206e","#33ccff","#cc00cc"],
  borderWidth: 1
}]
},
options: {
