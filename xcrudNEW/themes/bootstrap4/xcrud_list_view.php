...
<?php if ($this->is_create or $this->is_csv or $this->is_print){?>
        ...
        <div class="xcrud-top-actions list-only">
        ...
        ?>
        <button class="btn btn-primary" type="button" onclick="Xcrud.deleteItems(this);">Delete Selected</button>
        <?php
        }
        ?>
         <?php
        ...
        ?>
        <button class="btn btn-primary" type="button" onclick="Xcrud.editItems(this);">Edit Selected</button>
        <?php
        }
        ?>
