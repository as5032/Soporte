...
$xcrud->where('tipo_usuario<>1 AND id not in (1,2)'); //solo sistemas
$xcrud->hide_button('save_new');
$xcrud->hide_button('save_edit');
$xcrud->order_by('nombre_completo');
$xcrud->change_type('contra', 'password', 'md5'); //campo afectado, manejo de informacion.
$xcrud->change_type('nombre_completo', 'text', 'md5');
